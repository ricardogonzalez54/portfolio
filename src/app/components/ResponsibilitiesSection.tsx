  ...
  return (
    <div className="mb-6">
      <button
        ...
        className="cursor-pointer w-full flex items-center justify-between font-semibold text-gray-900 dark:text-white mb-3 hover:text-blue-600 dark:hover:text-blue-500 transition-colors duration-150"
      >
